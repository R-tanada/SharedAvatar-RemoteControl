...
if __name__ == "__main__":
    ...
    core_api.init_api(app_path='/Users/sprout/.conan/data/AvatarCore/1.13.1/_/_/package/46bcd792910b74a0e4ed230ba0eb49551adb1f5c/bin/pyTests', master=False, port=0, app_name="UserClient")
    ...
    try:
        while True:
            time.sleep(1)
            # data = {'user':1}
            # user_data.send_data(json.dumps(data))
